...
- Devido à ocupação do prédio do Setor de Exatas, a aula desta
  quarta-feira (09/11) será no Laboratório de Estatística (LABEST).
- O LABEST fica no prédio em frente ao prédio de Exatas (prédio baixo
  marrom), com a entrada virada para o lado oposto (toldo azul).
...
- **Horários e Locais:**
    - Quarta, 13:30 - 16:50, **PA03 (prédio novo do setor de Exatas)**
    - ~~Segunda, 13:30 - 15:10h, **PA01 (prédio novo do setor de Exatas)**~~
    - ~~Quarta, 13:30 - 15:10h, **PA01 (prédio novo do setor de Exatas)**~~
