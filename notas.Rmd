...
```{r, include=FALSE}
## Calcula a média
notas$Média <- apply(notas[, 2:4], 1, mean)

## Arredonda a media para uma casa decimal
notas$Média <- round(notas$Média, 1)

## Situação
notas$Situação <- NA
notas$Situação <- ifelse(notas$Média < 7, "Exame", "Aprovado")
```
